...
export const tools: Tool[] = [
	{
		...
		shortName: 'TikTok',
		platform: 'tiktok',
		description: 'Download TikTok videos without watermark for free. Paste any TikTok link and save clean HD videos to your device instantly. No signup required.',
		h1: 'Download TikTok Videos Without Watermark',
		placeholder: 'https://www.tiktok.com/@user/video/1234567890',
		color: '#000000',
		keywords: ['tiktok downloader', 'download tiktok without watermark', 'tiktok video downloader no watermark', 'save tiktok', 'tiktok video saver'],
		supportedTypes: ['video'],
		content: `TikTok is the most popular short-form video platform, and sometimes you want to save a video to watch offline or share it somewhere else. Our free TikTok downloader lets you save any public TikTok video without the watermark in HD quality.\n\nJust copy the TikTok video link from the app or website, paste it in the box above, and hit download. You'll get a clean video without the TikTok logo overlay, saved directly to your device. Works on iPhone, Android, Windows, and Mac — no app installation needed.\n\nThis tool only downloads publicly available videos. We do not store any videos on our servers. The download happens directly between your browser and the source servers.`,
		faq: [
			...
			{ q: 'Does this remove the TikTok watermark?', a: 'Yes, videos are downloaded without the TikTok watermark by default. You get a clean HD video file.' },
